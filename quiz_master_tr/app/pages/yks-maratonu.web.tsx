      ...
      <main className="flex-1 overflow-y-auto w-full">
        <div className="py-12 px-6 w-full max-w-4xl mx-auto space-y-12 pb-24">
          ...
          <header className="space-y-6">
            ...
            <h1 className="text-5xl font-black font-headline text-on-surface uppercase italic leading-tight">YKS Maratonunda Derece Yapmanın Formülü</h1>
            <p className="text-2xl text-on-surface-variant font-medium leading-relaxed">Konu Analizi ve Doğru Kaynak Seçimi</p>
          </header>
          ...
          <article className="prose prose-lg max-w-none text-on-surface-variant leading-relaxed space-y-8">
            <div className="p-10 bg-surface-container-lowest rounded-[2.5rem] border border-outline-variant/15 shadow-2xl shadow-black/[0.02] content-area">
              <style>
                ...
                <div>
      <h3>1. Konu Analizi ve Önceliklendirme</h3>
      <p>YKS'de başarılı olmanın ilk adımı, hangi konudan kaç soru çıktığını bilmektir. ÖSYM'nin son 5 yılını analiz ederek en çok soru gelen konulara odaklanın.</p>
      <ul>
        <li><b>TYT Türkçe:</b> Paragraf soruları her gün çözülmeli.</li>
        <li><b>Matematik:</b> Problemler ve Geometri temel taşıdır.</li>
      </ul>
      <h3>2. Kaynak Seçimi</h3>
      <p>Seviyenizin çok üstünde veya çok altında kaynaklar zaman kaybıdır. Kolaydan zora doğru bir ilerleme kaydedin. MEB kazanım testlerini mutlaka çözün.</p>
      <h3>3. Deneme Stratejisi</h3>
      <p>Sadece deneme çözmek yetmez. Deneme sonrası yapılan "Yanlış Analizi" sizi dereceye taşır. Hatayı nerede yaptığınızı bulun: Bilgi eksikliği mi, dikkat hatası mı yoksa süre yönetimi mi?</p>
</div>
