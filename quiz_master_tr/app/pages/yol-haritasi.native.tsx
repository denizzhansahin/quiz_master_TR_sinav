      ...
      <View className="flex-1 bg-surface text-on-surface flex-col">
        ...
        <ScrollView className="px-6 pb-12 w-full pt-4 max-w-md self-center">
          ...
          <View className="mb-10">
            ...
            <Text className="text-3xl font-extrabold font-headline text-on-surface leading-tight mb-3">Sıfırdan Başlayanlar İçin Yol Haritası</Text>
            <Text className="text-on-surface-variant font-medium text-lg leading-relaxed">Hedef Belirleme ve Haftalık Plan Hazırlama</Text>
          </View>

          <View className="bg-white p-8 rounded-[2.5rem] border border-outline-variant/10 shadow-sm mb-12">
            <Text style={styles.contentText}>
              Adım 1: Büyük Resmi Görün
Nereye gitmek istediğinizi bilmeden yol alamazsınız. Hedeflediğiniz üniversite/meslek için gereken puanı netleştirin.
Adım 2: Seviye Tespit
Hemen bir deneme çözerek mevcut durumunuzu görün. Hangi derslerde iyisiniz, hangileri zayıf?
Adım 3: Haftalık Plan
Esnek bir program yapın. Her güne en az bir sayısal bir sözel ders koyarak dengeli ilerleyin. Pazar günlerini mutlaka genel tekrar ve dinlenmeye ayırın.
