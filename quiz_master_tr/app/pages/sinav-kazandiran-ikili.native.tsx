      ...
      <View className="flex-1 bg-surface text-on-surface flex-col">
        ...
        <ScrollView className="px-6 pb-12 w-full pt-4 max-w-md self-center">
          ...
          <View className="mb-10">
            ...
            <Text className="text-3xl font-extrabold font-headline text-on-surface leading-tight mb-3">Sınav Kazandıran İkili</Text>
            <Text className="text-on-surface-variant font-medium text-lg leading-relaxed">Quiz Master TR ve Pomodoro APP Birlikte Kullanım</Text>
          </View>

          <View className="bg-white p-8 rounded-[2.5rem] border border-outline-variant/10 shadow-sm mb-12">
            <Text style={styles.contentText}>
              Sinerjik Çalışma Modeli
En iyi öğrenme, disiplinli çalışma ve sürekli test etme ile gerçekleşir. İşte başarının reçetesi:
Pomodoro ile Başlayın: 25 dakikalık bloklar halinde konu çalışmanızı yapın.
Mola Verin: 5 dakika zihninizi boşaltın.
Quiz Master ile Pekiştirin: Her 2 veya 4 pomodoro sonunda Quiz Master üzerinden o konuyla ilgili soruları çözerek kendinizi sınayın.
Bu yöntemle hem odağınızı koruyacak hem de bilgilerin ne kadarının kalıcı olduğunu anında göreceksiniz.
            </Text>
