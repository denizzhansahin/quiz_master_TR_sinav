      ...
      <View className="flex-1 bg-surface text-on-surface flex-col">
        ...
        <ScrollView className="px-6 pb-12 w-full pt-4 max-w-md self-center">
          ...
          <View className="mb-10">
            ...
            <Text className="text-3xl font-extrabold font-headline text-on-surface leading-tight mb-3">Doğru Dinlenme Teknikleri</Text>
            <Text className="text-on-surface-variant font-medium text-lg leading-relaxed">Masa Başından Uzaklaşmadan Mola Vermek</Text>
          </View>

          <View className="bg-white p-8 rounded-[2.5rem] border border-outline-variant/10 shadow-sm mb-12">
            <Text style={styles.contentText}>
              Mola Nedir, Ne Değildir?
Mola vermek, beyninizin az önce öğrendiği bilgileri organize etmesi için gereken süredir. Molayı yanlış kullanmak, çalışmanın verimini öldürür.
Yanlış Mola: Sosyal medyada gezmek, oyun oynamak (Zihni daha çok yorar).
Doğru Mola: Su içmek, derin nefes almak, pencereden uzağa bakmak, hafif esneme hareketleri yapmak.
5 dakikalık bir mola sırasında ekranlardan tamamen uzak durun. Bu, bir sonraki seansa taze bir zihinle başlamanızı sağlar.
            </Text>
