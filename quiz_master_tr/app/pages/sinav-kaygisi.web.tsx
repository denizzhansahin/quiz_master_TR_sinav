      ...
      <main className="flex-1 overflow-y-auto w-full">
        <div className="py-12 px-6 w-full max-w-4xl mx-auto space-y-12 pb-24">
          ...
          <header className="space-y-6">
            ...
            <h1 className="text-5xl font-black font-headline text-on-surface uppercase italic leading-tight">Sınav Kaygısıyla Baş Etme Yolları</h1>
            <p className="text-2xl text-on-surface-variant font-medium leading-relaxed">Zihninizi Başarıya Nasıl Programlarsınız?</p>
          </header>
            ...
            <div className="p-10 bg-surface-container-lowest rounded-[2.5rem] border border-outline-variant/15 shadow-2xl shadow-black/[0.02] content-area">
              <style>
                {`.content-area h3 { font-family: 'Outfit', sans-serif; font-weight: 800; color: #1a1c1e; font-size: 1.5rem; margin-top: 2rem; margin-bottom: 1rem; text-transform: uppercase; letter-spacing: -0.02em; }\n` +
                 ...
                 <div>
      <h3>Kaygıyı Kabul Edin</h3>
      <p>Bir miktar kaygı normaldir ve sizi zinde tutar. Ancak kaygı yönetilemez hale gelirse performansı düşürür.</p>
      <h3>Zihinsel Teknikler</h3>
      <ul>
        <li><b>Nefes Egzersizi:</b> Kaygı anında 4 saniye nefes alın, 4 saniye tutun ve 8 saniyede verin.</li>
        <li><b>Olumlamalar:</b> "Yeterince çalıştım", "Bu sınav benim değerimi belirlemez" gibi cümlelerle iç sesinizi sakinleştirin.</li>
      </ul>
      <h3>Yaşam Tarzı</h3>
      <p>Düzenli uyku ve şekerden uzak bir beslenme düzeni, stres hormonlarını dengede tutar. Yürüyüş yapmayı ihmal etmeyin.</p>
</div>
