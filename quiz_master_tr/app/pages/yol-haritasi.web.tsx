      ...
      <main className="flex-1 overflow-y-auto w-full">
        <div className="py-12 px-6 w-full max-w-4xl mx-auto space-y-12 pb-24">
          ...
          <header className="space-y-6">
            ...
            <h1 className="text-5xl font-black font-headline text-on-surface uppercase italic leading-tight">Sıfırdan Başlayanlar İçin Yol Haritası</h1>
            <p className="text-2xl text-on-surface-variant font-medium leading-relaxed">Hedef Belirleme ve Haftalık Plan Hazırlama</p>
          </header>
          ...
          <article className="prose prose-lg max-w-none text-on-surface-variant leading-relaxed space-y-8">
            <div className="p-10 bg-surface-container-lowest rounded-[2.5rem] border border-outline-variant/15 shadow-2xl shadow-black/[0.02] content-area">
              ...
              <div>
      <h3>Adım 1: Büyük Resmi Görün</h3>
      <p>Nereye gitmek istediğinizi bilmeden yol alamazsınız. Hedeflediğiniz üniversite/meslek için gereken puanı netleştirin.</p>
      <h3>Adım 2: Seviye Tespit</h3>
      <p>Hemen bir deneme çözerek mevcut durumunuzu görün. Hangi derslerde iyisiniz, hangileri zayıf?</p>
      <h3>Adım 3: Haftalık Plan</h3>
      <p>Esnek bir program yapın. Her güne en az bir sayısal bir sözel ders koyarak dengeli ilerleyin. Pazar günlerini mutlaka genel tekrar ve dinlenmeye ayırın.</p>
      <p>Unutmayın; en kötü plan, plansızlıktan iyidir.</p>
</div>
